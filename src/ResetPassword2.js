  ...
  return (
    <div>
      ...
      <div  style={{ float: 'center', maxWidth: '700px' , margin: '0 auto'}}>
        ...
        <Input placeholder="New Password" type="password" style={{ float: 'center', width: '50%', maxHeight: '45px', fontSize: '20px', marginTop: '18px', marginLeft: '10px' }}
        onChange={(event, data) => {
        ...
        />
        <Button primary style={{ float: 'center', width: '50%', marginTop: '20px', marginLeft: '10px', borderRadius: '50px', fontSize: '18px' }} content="Submit"
        onClick={ async () => {
          ...
          const settings = {
            ...
            body: JSON.stringify({"password": resetPassword}, {"token" : token})
          }
